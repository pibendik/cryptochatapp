...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, displayName: $displayName, publicKeyBase64: $publicKeyBase64, avatarUrl: $avatarUrl, skills: $skills)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, displayName, publicKeyBase64,
      avatarUrl, const DeepCollectionEquality().hash(_skills));
...
abstract class _User implements User {
  const factory _User(
      ...
      final String? avatarUrl,
      final List<String> skills}) = _$UserImpl;
